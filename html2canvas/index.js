...
let canvasObj = document.querySelector('.test1');
...
context.scale(1,1 );
context.translate('-'+(canvasObj.offsetLeft),'-'+(canvasObj.offsetTop))
...
// 完整下载
// html2canvas(document.querySelector('.test1'), { canvas: canvas2 }).then(function(canvas) {
